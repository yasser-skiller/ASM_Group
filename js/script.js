		...
		var $sync1 = $(".specialize-section-two .image-carousel"),
			...
			$sync2
				.owlCarousel({
					...
					items: 1,
					nav: true,
					navText: [ '<span class="fa fa-long-arrow-left"></span> السابق', 'التالي<span class="fa fa-long-arrow-right"></span>' ],
					dots: false,
					center: false,
					autoplay: true,
					mouseDrag:true,
	...
	if($('.accordion-box').length){
		$(".accordion-box").on('click', '.acc-btn', function() {
			...
			if($(this).hasClass('active')!==true){
				...
				$(outerBox).children('.accordion').addClass('active-block animated fadeInUp');
				$(outerBox).find('.accordion').children('.acc-content').slideDown(300);
				target.removeClass('active-block animated fadeInUp');
